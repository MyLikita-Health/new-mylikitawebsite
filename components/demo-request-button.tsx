      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <Button
            variant={variant}
            size={size}
            className={`rounded-full px-8 py-4 text-lg font-semibold ${className}`}
          >
            Request Demo
        ...
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold font-space-grotesk text-center">
              Schedule Your Demo
            </DialogTitle>
            <DialogDescription className="text-center text-lg">
              See how MyLikita can transform your healthcare facility. Fill out
            ...
            {isSuccess ? (
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Thank you for your interest in MyLikita. Our team will contact
              ...
              >
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    ...
                    We'll use your information to contact you about MyLikita
