  ...
  return (
    <div className="container max-w-3xl py-12">
      <div className="mb-8 flex flex-col gap-1">
        ...
        <h1 className="font-space-grotesk text-3xl font-bold">{post.title}</h1>
        <p className="text-gray-500 dark:text-gray-400">{post.description}</p>
      </div>
      <div
        className="prose prose-lg max-w-none prose-headings:font-space-grotesk prose-headings:text-gray-900 dark:prose-headings:text-white prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 dark:prose-strong:text-white prose-blockquote:border-blue-500 prose-blockquote:bg-blue-50 dark:prose-blockquote:bg-blue-900/20 prose-code:bg-gray-100 dark:prose-code:bg-gray-800 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-pre:bg-gray-900 prose-pre:text-gray-100"
        dangerouslySetInnerHTML={{ __html: post.content }}
      />
      <div className="mt-12">
        <a
          href={`${siteConfig.links.github}/blob/main/content/${post.slug}.mdx`}
          target="_blank"
          rel="noreferrer"
          className={cn(
