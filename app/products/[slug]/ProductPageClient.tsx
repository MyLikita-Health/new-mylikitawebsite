...
const products = {
  hms: {
    ...
    features: [
      {
        ...
        description: "Complete electronic health records with medical history, allergies, and treatment plans",
        icon: Users,
      },
      {
        title: "Integrated Billing System",
        description: "Automated billing with insurance claims processing and payment tracking",
        icon: BarChart3,
      },
      {
        title: "Electronic Prescriptions",
        description: "Digital prescription management with drug interaction checking",
        icon: Pill,
      },
      {
      ...
      },
      {
        ...
        description: "Centralized management for hospital chains and multi-branch facilities",
        icon: Shield,
      },
    ],
    benefits: [
    ...
    testimonials: [
      {
        quote: "MyLikita HMS transformed our hospital operations completely. Patient satisfaction increased by 80%.",
      ...
      {
        quote: "The billing system alone saved us 20 hours per week. Incredible efficiency gains.",
  ...
  labcore: {
    ...
    features: [
      {
        ...
        description: "Pre-configured test panels with customizable parameters and protocols",
        icon: Zap,
      },
      {
        title: "Sample Tracking",
        description: "Barcode-enabled sample tracking from collection to disposal",
        icon: BarChart3,
      },
      {
        title: "Quality Control",
        description: "Comprehensive QC management with statistical analysis and trending",
        icon: Shield,
      },
      {
      ...
      },
      {
        ...
        description: "Intelligent report generation with customizable templates",
        icon: BarChart3,
      },
      {
        title: "Inventory Management",
        description: "Real-time reagent and consumable tracking with automated reordering",
        icon: Clock,
      },
    ],
    benefits: [
    ...
    testimonials: [
      {
        quote: "LabCore reduced our turnaround time from 24 hours to 4 hours. Patients are much happier.",
  ...
  scanris: {
    ...
    features: [
      {
        ...
        description: "Advanced DICOM viewer with measurement tools and image enhancement",
        icon: Scan,
      },
      {
        title: "Workflow Management",
        description: "Streamlined radiology workflow from order to report delivery",
        icon: BarChart3,
      },
      {
        title: "Image Archiving",
        description: "Secure cloud-based image storage with instant retrieval",
        icon: Shield,
      },
      {
        title: "Report Templates",
        description: "Customizable reporting templates with voice recognition support",
        icon: Users,
      },
      {
        title: "Teleradiology",
        description: "Remote reading capabilities with secure image transmission",
        icon: Video,
      },
      {
        title: "Quality Assurance",
        description: "Comprehensive QA tools for image quality and report accuracy",
        icon: CheckCircle,
      },
    ],
    benefits: [
    ...
    testimonials: [
      {
        quote: "ScanRIS enabled us to provide 24/7 radiology services with remote reading capabilities.",
  ...
  pharmabooks: {
    ...
    description:
      "PharmaBooks is a comprehensive pharmacy accounting and inventory management system designed for hospital pharmacies and retail outlets across Africa.",
    longDescription:
    ...
    features: [
      {
        title: "Inventory Management",
        description: "Real-time stock tracking with automated reorder points and supplier management",
        icon: BarChart3,
      },
      {
        title: "Point of Sale",
        description: "Advanced POS system with multiple payment methods and receipt printing",
        icon: Zap,
      },
      {
      ...
      },
      {
        ...
        description: "Automated expiry date tracking with alerts and FEFO dispensing",
        icon: Clock,
      },
      {
        title: "Financial Reporting",
        description: "Detailed financial reports with profit analysis and tax compliance",
        icon: BarChart3,
      },
      {
        title: "Prescription Processing",
        description: "Electronic prescription processing with insurance claim management",
        icon: Users,
      },
    ],
    benefits: [
    ...
    testimonials: [
      {
        quote: "PharmaBooks helped us reduce expired medications by 80% and increase profits by 25%.",
  ...
  medilinka: {
    ...
    features: [
      ...
      },
      {
        ...
        description: "Real-time patient vital signs monitoring with IoT device integration",
        icon: BarChart3,
      },
      {
        title: "Digital Prescriptions",
        description: "Electronic prescription generation with direct pharmacy integration",
        icon: Pill,
      },
      {
        title: "TelePharmacy Services",
        description: "Remote pharmaceutical care with medication delivery coordination",
        icon: Users,
      },
      {
        title: "Secure Messaging",
        description: "HIPAA-compliant messaging system for patient-provider communication",
        icon: Shield,
      },
      {
        title: "Payment Integration",
        description: "Multiple payment options including mobile money and insurance billing",
        icon: Zap,
      },
    ],
    benefits: [
    ...
    testimonials: [
      {
        quote: "MediLinka allowed us to serve rural communities we never could reach before. Amazing impact!",
              ...
              <motion.div variants={fadeInUp}>
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-400 mt-2">{product.subtitle}</p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">{product.longDescription}</p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Comprehensive features designed to meet your specific healthcare needs
            </p>
          </motion.div>
                  ...
                  {isSubmitted ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Our team will contact you within 24 hours to discuss {product.name} and how it can benefit your
                        organization.
                      </p>
                    </div>
                  ) : (
